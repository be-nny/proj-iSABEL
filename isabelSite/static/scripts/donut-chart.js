var Dial = function(container) {
    ...
    this.value = (parseFloat(this.container.dataset.exp)/parseFloat(this.container.dataset.total))*100;
...
Dial.prototype.createText = function() {
    ...
    text.innerHTML = 0 + '<tspan font-size="' + tspanSize + '" dy="' + -tspanSize * 1.2 + '">xp</tspan>';
...
Dial.prototype.setValue = function(value) {
    ...
    this.text.innerHTML = Math.floor((value/100)*this.container.dataset.total) + '<tspan font-size="' + tspanSize + '" dy="' + -tspanSize + '">xp</tspan>';
};
